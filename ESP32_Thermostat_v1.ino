...
//################ VARIABLES ################
String ssid       = "TALKTALK622264";             // WiFi SSID     replace with details for your local network
String password   = "talktalk0825";         // WiFi Password replace with details for your local network
